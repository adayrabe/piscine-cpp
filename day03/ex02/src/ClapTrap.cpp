...
{
    std::cout << "CL4P-TP " << this->_name << " is constructed with chosen name. I like this name!" << std::endl;
    return ;
}
...
{
    *this = other;
    std::cout << "ClapTrap " << this->_name << " is constructed from another ClapTrap! How cool is that!" << std::endl;
    return ;
}
...
ClapTrap::~ClapTrap(void)
{
    std::cout << "Oh nooooo! a ClapTrap " << this->_name << " is dead!" << std::endl;
    return ;
}
